;;;
;;; This is Suggested Project 7.9.2.3
;;; Basically do simple signed addition, subtraction, multiplication, modulo
;;; With unsigned word and double-word sizes
...
wAns8:          dw 0    ; wAns8  = wNum2 - wNum4 300 - 500 = -200 => 65336
...
_start:
        ...
        movzx   ecx, word [wNum4]       ; Divisor has to be dword so convert
        div     ecx
        mov     word [wAns18], ax
