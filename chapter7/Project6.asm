...
dAns8:          dd 0    ; dAns8  = dNum2 - dNum4 400000
...
_start:
        ...
        ;; dAns11 = dNum1 * dNum3
        mov     eax, dword [dNum1]
        imul    dword [dNum3]           ; Pg. 102 multi tables
        ...
        mov     eax, dword [dNum1]
        cdq
        idiv    dword [dNum2]           ; Pg. 110 Divide tables
        ...
        movsxd  rcx, dword [dNum4]      ; Specific command for signed dword to qword
        idiv    rcx
